  ...
  <md-sidenav class="main-sidebar md-left md-fixed" md-swipeable ref="main-sidebar">
    ...
    <div class="main-sidebar-links">
      <md-list class="md-dense">
        <md-list-item>
          <router-link exact to="/theme">Theme</router-link>
        </md-list-item>
        <md-list-item>
          <router-link exact to="/components">Components</router-link>
        </md-list-item>
        <md-list-item>
...
export default {
  ...
  computed: {
    logo () {
      ...
      let logo = require('assets/logo-vue-material-' + theme + '.png')
      let defaultLogo = require('assets/logo-vue-material-default.png')
