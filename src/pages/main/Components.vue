<template>
<page-content page-title="Components">
  <div class="components-links">
    <md-list class="md-dense">
      ...
      <md-divider></md-divider>
      <md-list-item>
        <router-link exact to="/components/button-toggle">ButtonToggle</router-link>
      </md-list-item>
      <md-divider></md-divider>
      <md-list-item>
      ...
      <md-divider></md-divider>
      <md-list-item>
        <router-link exact to="/components/image-loader">ImageLoader</router-link>
      </md-list-item>
      <md-divider></md-divider>
      <md-list-item>
      ...
      <md-divider></md-divider>
      <md-list-item>
        <router-link exact to="/components/speeddial">SpeedDial</router-link>
      </md-list-item>
      <md-divider></md-divider>
      <md-list-item>
...
<style lang="scss">
@import "src/stylesheets/commonCss.scss";
