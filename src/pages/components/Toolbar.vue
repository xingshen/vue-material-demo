<template>
<page-content-back page-title="Toolbar">
  <div class="main-content">
    ...
    <block-content block-title="Sizes">
      <div class="block-content">
        ...
        <md-toolbar class="md-medium toolbar">
    ...
    <block-content block-title="Palettes">
      <div class="block-content">
        <md-toolbar class="md-accent toolbar">
          <md-button class="md-icon-button">
            <md-icon>menu</md-icon>
          </md-button>
    ...
    <block-content block-title="Themes">
      <div class="block-content">
        <md-toolbar md-theme="green" class="toolbar">
          <md-button class="md-icon-button">
            <md-icon>menu</md-icon>
          </md-button>
        ...
        <md-toolbar class="md-large toolbar" md-theme="brown">
          <div class="md-toolbar-container">
            <md-button class="md-icon-button">
              <md-icon>menu</md-icon>
            </md-button>
        ...
        <md-toolbar md-theme="orange" class="toolbar">
          <md-button class="md-icon-button">
            <md-icon>menu</md-icon>
          </md-button>
        ...
        <md-toolbar md-theme="blue" class="toolbar">
          <md-button class="md-icon-button">
            <md-icon>menu</md-icon>
          </md-button>
    ...
    <block-content block-title="Complete Example">
      <div class="block-content">
